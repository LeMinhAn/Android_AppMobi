...
/**
 * Created by tobrother on 01/04/2016.
 */
...
public abstract class BaseFragment extends Fragment {
    public abstract ArrayList<CardItem> getDummyData();
    ...
    protected void setDummyData(RecyclerView recyclerView) {
        recyclerView.setAdapter(new DataBidingAdapter(getActivity(), getDummyData()));
    }
