 ...
 */
public class ParallaxRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolderImpl(RecyclerView.ViewHolder holder, ParallaxRecyclerAdapter adapter, int position) throws JSONException {
        ...
        switch (itemCards.get(position).getCard_type()) {
            ...
            case Constants.HOME_CARD_TYPE.VERTICAL_CARD:
                ...
                viewHolderVerticalCard.setValue(mItem, context, Constants.options);
                break;
    ...
    public RecyclerView.ViewHolder onCreateViewHolderImpl(ViewGroup parent, ParallaxRecyclerAdapter adapter, int ViewType) {
    ...
    public ParallaxRecyclerAdapter(ArrayList<CardItem> data) {
        itemCards = data;
    }
