...
/**
 * Created by tobrother on 29/02/2016.
 */
public class CustomRatingBarListItem extends LinearLayout {
    ...
    private int mStarOnResource = R.drawable.star_on_blue;
    private int mStarOffResource = R.drawable.star_off_blue;
    private int mStarHalfResource = R.drawable.star_half_blue;
    ...
    public CustomRatingBarListItem(Context context) {
        super(context);
        init();
    }
    ...
    public CustomRatingBarListItem(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarListItem(Context context, AttributeSet attrs, int defStyle) {
