 ...
 */
public class CustomRatingBarGuest extends LinearLayout {
    ...
    public CustomRatingBarGuest(Context context) {
        super(context);
        init();
    }
    ...
    public CustomRatingBarGuest(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomRatingBarGuest(Context context, AttributeSet attrs, int defStyle) {
